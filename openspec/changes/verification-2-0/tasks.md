...
- [x] 5.4 Reviewer can inspect expected, actual, oracle, and evidence for every assertion reading.
...
- [x] 7.4 Reviewer can block repair start and replay when any artifact replaces the original failed attempt identity.
...
- [x] 8.2 Verification operator can rerun concrete impacted cases plus mandatory baselines using CodeGraph and policy evidence.
...
- [x] 9.4 Stakeholder can use desktop, mobile, keyboard, print, and escaped secret-safe report pages.
