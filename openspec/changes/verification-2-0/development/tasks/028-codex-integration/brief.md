# Task Brief: 028-codex-integration

## Goal

Codex user can discover and run Verification 2.0 through the Codex marketplace adapter.
...
Codex user can discover and run Verification 2.0 through the Codex marketplace adapter. The delivered slice must be directly demonstrable through the
listed verification commands and must preserve all earlier artifacts.

## In Scope

- Wire Codex manifests, skills, hooks, next actions, runtime commands, V2 gates, and report paths to the shared kernel.
...
- plugins/specnav-verification/.codex-plugin/**
- plugins/specnav-verification/skills/**
- plugins/specnav-verification/scripts/**
...
- Codex adapter translates host invocation only; all verdict behavior remains in the kernel.

## Components To Create

- Codex Verification 2.0 adapter

## Components To Reuse

- Verification Kernel
- Codex marketplace and hook patterns

## Components To Extract

- Codex-only invocation and configuration lookup

## API / Data Flow Contracts

- Capability spec: `openspec/changes/verification-2-0/specs/cross-host-verification-governance/spec.md`.
- Acceptance assertions: `AC-03`, `AC-37`, `AC-40`.
- Codex discovers the plugin, routes verification actions, invokes the kernel, and surfaces exact artifacts and blockers.
...
- Stop if a dependency task is incomplete: `016-six-domain-aggregation`, `020-retest-regression-loop`, `025-case-report-pages`, `027-v1-v2-migration`.
...
Task packet path: `openspec/changes/verification-2-0/development/tasks/028-codex-integration`.
