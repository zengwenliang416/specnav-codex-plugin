...
<p align="center">
  <img src="docs/assets/readme/zh-CN/specnav-overview-bd-2k.jpg" alt="SpecNav 生命周期总览图" width="100%">
</p>
...
<table>
  <tr>
    <td width="50%">
      ...
      <img src="docs/assets/readme/zh-CN/stage-1-bootstrap-bd-2k.jpg" alt="SpecNav 初始化阶段">
    </td>
    <td width="50%">
      <strong>2. 规范发现</strong><br>
      <img src="docs/assets/readme/zh-CN/stage-2-discovery-bd-2k.jpg" alt="SpecNav 规范发现阶段">
    </td>
  </tr>
  <tr>
    <td width="50%">
      <strong>3. 需求问需</strong><br>
      <img src="docs/assets/readme/zh-CN/stage-3-requirements-bd-2k.jpg" alt="SpecNav 需求阶段">
    </td>
    <td width="50%">
      <strong>4. 原型验证</strong><br>
      <img src="docs/assets/readme/zh-CN/stage-4-prototype-bd-2k.jpg" alt="SpecNav 原型阶段">
    </td>
  </tr>
  <tr>
    <td width="50%">
      <strong>5. 垂直开发</strong><br>
      <img src="docs/assets/readme/zh-CN/stage-5-development-bd-2k.jpg" alt="SpecNav 开发阶段">
    </td>
    <td width="50%">
      <strong>6. 六域验证</strong><br>
      <img src="docs/assets/readme/zh-CN/stage-6-verification-bd-2k.jpg" alt="SpecNav 验证阶段">
    </td>
  </tr>
  <tr>
    <td colspan="2">
      <strong>7. 运维归档</strong><br>
      <img src="docs/assets/readme/zh-CN/stage-7-operations-bd-2k.jpg" alt="SpecNav 运维阶段">
    </td>
  </tr>
</table>
