...
function blockedResult({
  ...
  runtimeScope = null,
  runtimeBase = null,
  scopeSelectionSource = null,
  providerScope = runtimeScope,
  providerSource = runtimeScope === 'explicit'
    ? 'process-environment'
    : 'scope-file',
  providerFile = null,
  checks,
...
function doctorRuntime(options = {}) {
  const {
    ...
    runtimeScope = 'explicit',
    scopeSelectionSource = 'runtime-argument',
    providerScope = runtimeScope,
    providerSource = runtimeScope === 'explicit'
      ? 'process-environment'
      : 'scope-file',
  ...
  return {
    ...
    runtime_root: runtimeRoot,
    runtime_scope: runtimeScope,
    runtime_base: path.resolve(runtimeBase),
    scope_selection_source: scopeSelectionSource,
    provider_scope: providerScope,
    provider_source: providerSource,
    provider_file: providerFile,
